...
export const RecipeList: recipe[] = [
	...
	},
	{
		...
		time: "120m",
		effects: "When introduced to the bloodstream by mouth or wound, inflicts a WIS and CON Debility, and deals 1 Stamina Damage per round for 12 rounds.",
	...
	},
	{
		...
		time: "120m",
		effects: "When introduced to the bloodstream by mouth or wound, inflicts a INT and STR Debility, and deals 1 Stamina Damage per round for 12 rounds.",
	...
	},
	{
		...
		reagents: [ReagentProperties.Poi, ReagentProperties.Poi, ReagentProperties.Hyd, ReagentProperties.Hyd, ReagentProperties.For, ReagentProperties.For],
		dc: 6
	},
	{
		type: "Potion",
	...
	},
	{
		...
		time: "60m",
		effects: "When applied to the skin and clothing, reduces the effects of heat, fire and Radiant.  Any Stamina loss caused by Fire or Radient energy is reduced by 2 and any negatives applied to rolls due to fire are halved.  Lasts 2 hours.",
	...
	},
	{
		...
		time: "60m",
		effects: "When applied to the skin and clothing, reduces the effects of lightning and acid.  Any Stamina loss caused by Lightning or Acid energy is reduced by 2.  Lasts 2 hours.",
	...
	},
	{
		...
		time: "60m",
		effects: "When applied to the skin and clothing, reduces the effects of cold and wind.  Any Stamina loss caused by Sound or Wind energy is reduced by 2 and any negatives applied to rolls due to cold are halved.  Lasts 2 hours.",
	...
	},
	{
		...
		time: "30m",
		effects: "When you create this, name an animal and perform an Animal Handling Move.  If you do not fail the Move, yournamed animals are attracted from 1km.  Lasts 8 hours.",
		reagents: [ReagentProperties.Vig],
		dc: 2
	},
	{
